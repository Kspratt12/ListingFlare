...
export const article: BlogPost = {
  slug: "first-time-home-sellers-guide",
  title:
  ...
  keywords: [
    ...
    "home selling process steps guide",
    "home selling process guide 2025",
    "home selling process pricing guide",
...
<ul>
  <li><strong>Agent commissions:</strong> Sellers typically pay 5–6% of the sale price, split between the listing and buyer's agent.</li>
  <li><strong>Closing costs:</strong> Title insurance, transfer taxes, attorney fees, and prorated property taxes usually total 1–3% of the sale price.</li>
  <li><strong>Repairs and prep:</strong> Budget \$2,000–\$10,000 depending on your home's condition.</li>
  <li><strong>Moving expenses:</strong> A local move averages \$1,500–\$3,000; long-distance moves can exceed \$5,000.</li>
</ul>
...
<h3>Questions to Ask During Agent Interviews</h3>
<ol>
  <li>How many homes have you sold in this area in the last 12 months?</li>
  <li>What's your average days-on-market compared to the local average?</li>
  <li>What does your marketing plan include beyond the MLS?</li>
  <li>How will you determine the right listing price?</li>
  <li>What's your commission structure and what does it cover?</li>
</ol>
...
<p>Pricing is the single most important decision you'll make as a seller. Price too high and your listing sits on the market, growing stale. Price too low and you leave money on the table. This section of our <strong>home selling process pricing guide</strong> will help you understand how smart pricing works.</p>
...
<ul>
  <li>Basing your price on what you <em>need</em> rather than what the market supports.</li>
  <li>Adding the cost of renovations dollar-for-dollar to your asking price (most renovations don't return 100%).</li>
  <li>Ignoring your agent's pricing recommendation because a neighbor "got more" for a house that may have been very different from yours.</li>
</ul>
...
<p>Buyers need to envision themselves living in your space, and that's hard to do when your family photos, collections, and personal items are everywhere. Pack away anything that screams "someone else lives here." As a bonus, this gives you a head start on packing for your move.</p>

<p>Key areas to tackle:</p>
<ul>
...
<ul>
  <li>Full kitchen or bathroom remodels right before selling.</li>
...
<h3>Curb Appeal Checklist</h3>

<p>First impressions start at the curb. Before your listing goes live:</p>
<ol>
...
<p>When offers start coming in, it's tempting to focus only on the price. But a savvy seller looks at the full picture.</p>

<h3>Understanding Offer Components</h3>
<ul>
...
<p>You don't have to accept or reject an offer outright. Counter-offers are standard. You might counter on price, ask the buyer to waive a contingency, adjust the closing date, or request that the buyer cover specific closing costs. Your agent will advise you on what's reasonable and strategic.</p>
...
<p>After you accept an offer, the deal enters the <strong>due diligence period</strong>. This is when the buyer conducts inspections and the lender orders an appraisal. It's one of the most nerve-wracking parts of the home selling process, but knowing what to expect makes it manageable.</p>
...
<p>You're almost at the finish line! Closing (sometimes called "settlement") is when ownership officially transfers from you to the buyer.</p>
...
<ul>
  <li><strong>Agent commissions:</strong> 5–6% of the sale price (the single largest cost).</li>
  <li><strong>Title insurance:</strong> \$500–\$2,000 depending on sale price and location.</li>
  <li><strong>Transfer taxes:</strong> Vary by state and municipality; check with your agent or attorney.</li>
  <li><strong>Attorney fees:</strong> \$500–\$1,500 in states that require a real estate attorney.</li>
  <li><strong>Prorated property taxes:</strong> You pay for the portion of the year you owned the home.</li>
  <li><strong>Mortgage payoff:</strong> Your remaining loan balance plus any accrued interest.</li>
</ul>

<h3>Timeline from Offer to Keys</h3>

<p>Most transactions close in <strong>30–45 days</strong> from accepted offer to closing. Cash deals can close in as few as 7–14 days. Delays can happen due to financing issues, title problems, or repair negotiations, but your agent and title company will keep things on track.</p>

<div class="faq-section">
<h2>Frequently Asked Questions</h2>

<h3>How long does it take to sell a house?</h3>
<p>The average home spends 30–60 days on the market before going under contract, plus another 30–45 days to close. In hot markets, well-priced homes can receive offers within days. Total timeline from listing to closing typically runs 2–4 months, though your prep time before listing can add another 2–6 weeks.</p>

<h3>How much does it cost to sell a home?</h3>
