        ...
        >
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="mt-12 space-y-5">
              ...
              <button
                type="submit"
                className="group flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 px-6 py-4 font-medium text-white transition-all hover:bg-brand-600 hover:shadow-lg hover:shadow-brand-500/20"
              >
                Request Showing
