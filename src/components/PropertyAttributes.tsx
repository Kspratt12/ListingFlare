...
// One row (label → value). Light panel on a dark outer background.
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        <div className="text-center">
          ...
          <p
            ...
            style={{ color: "color-mix(in srgb, var(--agent-brand, #b8965a) 55%, white)" }}
          >
            The Details
          </p>
        ...
        {/* Single white stat sheet sitting on the dark brand-tinted
            section. Top accent stripe links it back to the section's
            brand color. */}
        <div className="relative mt-10 overflow-hidden rounded-2xl border border-white/10 bg-white shadow-2xl shadow-black/30">
          <div
        ...
        {appliances && (
          <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-white shadow-xl shadow-black/20">
