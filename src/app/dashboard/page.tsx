          ...
          {sortedListings.map((listing) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {/* Action row — dedicated line so Edit + Social Pack + menu
                    never get truncated no matter how narrow the card. */}
                <div className="mt-3 flex items-center gap-2">
                  {listing.status === "archived" ? (
                    <button
                      ...
                      className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-700 transition-colors hover:bg-emerald-100"
                    >
                    ...
                    <Link
                      ...
                      onClick={(e) => e.stopPropagation()}
                      className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-brand-50 px-3 py-2 text-xs font-medium text-brand-700 transition-colors hover:bg-brand-100"
                      title="Edit listing"
                    >
                  ...
                  {listing.status === "published" && listing.photos.length > 0 && (
                    limits.canGenerateSocialPosts ? (
                      <button
                        ...
                        className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-purple-50 px-3 py-2 text-xs font-medium text-purple-700 transition-colors hover:bg-purple-100 disabled:opacity-60"
                      >
                        ...
                        <span className="whitespace-nowrap">{generatingPosts === listing.id ? "Building…" : "Social Pack"}</span>
                      </button>
                    ) : (
                      <Link
                        href="/dashboard/billing"
                        ...
                        className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-gray-100 px-3 py-2 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-200"
                      >
                        <Lock className="h-3.5 w-3.5" />
                        <span className="whitespace-nowrap">Social Pack</span>
                      </Link>
                    )
                  )}
                  <ListingActionsMenu
